...
namespace Articy.Zombo.Templates
{
    ...
    public class DefaultMainCharacterTemplateTemplate : IArticyBaseObject, IPropertyProvider
    {
        ...
        public Articy.Zombo.Features.DefaultExtendedCharacterFeatureFeature DefaultExtendedCharacterFeature
        {
            get
            {
        ...
        {
            Articy.Zombo.Templates.DefaultMainCharacterTemplateTemplate newClone = ((Articy.Zombo.Templates.DefaultMainCharacterTemplateTemplate)(aClone));
            if ((DefaultExtendedCharacterFeature != null))
            {
                newClone.DefaultExtendedCharacterFeature = ((Articy.Zombo.Features.DefaultExtendedCharacterFeatureFeature)(DefaultExtendedCharacterFeature.CloneObject(newClone, aFirstClassParent)));
            }
        ...
        {
            Articy.Zombo.Templates.DefaultMainCharacterTemplateTemplate clone = new Articy.Zombo.Templates.DefaultMainCharacterTemplateTemplate();
