...
namespace Articy.Zombo.Features
{
    ...
    public class DefaultBasicCharacterFeatureFeature : IArticyBaseObject, IPropertyProvider
    {
        ...
        {
            Articy.Zombo.Features.DefaultBasicCharacterFeatureFeature newClone = ((Articy.Zombo.Features.DefaultBasicCharacterFeatureFeature)(aClone));
            newClone.Age = Age;
            if ((mSpecies != null))
            {
        ...
        {
            Articy.Zombo.Features.DefaultBasicCharacterFeatureFeature clone = new Articy.Zombo.Features.DefaultBasicCharacterFeatureFeature();
